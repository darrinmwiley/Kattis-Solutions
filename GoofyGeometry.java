...
public class GoofyGeometry {
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        GoofyGeometry t = new GoofyGeometry();
    ...
    public void run() throws Exception
    {
        ...
        for(int z = 0;z<zz;z++)
        {
            ...
            double[] tan = tangent(x,y,0,0,1);
            LineInf li1 = new LineInf(x,y,tan[0],tan[1]);
            LineInf li2 = new LineInf(x,y,tan[2],tan[3]);
            pout.println("("+li1.A+","+li1.B+","+li1.C+","+li2.A+","+li2.B+","+li2.C+")");
        }
    }
